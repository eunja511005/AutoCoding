	...
	<div class="container my-4">
		<main>
			...
			<div class="row g-5 d-flex justify-content-center">
				<div class="col-md-10">
					<h4 class="my-4">Password Reset</h4>
					<form id="uploadForm" class="needs-validation" novalidate>
						<div class="row g-3">
							...
							<div class="col-12">
								<label for="password" class="form-label">Current Password</label> <small class="form-text text-danger">*</small> 
								<input
							...
							<div class="col-12">
								<label for="newPassword" class="form-label">New Password</label> <small class="form-text text-danger">*</small> 
								<input
							...
							<div class="col-12">
								<label for="confirmPassword" class="form-label">Confirm Password</label> <small class="form-text text-danger">*</small> 
								<input
