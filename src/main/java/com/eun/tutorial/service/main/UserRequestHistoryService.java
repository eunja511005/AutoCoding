...
public interface UserRequestHistoryService {
	List<UserRequestHistoryDTO> getUserRequestHistoryList();
	int saveUserRequestHistory(UserRequestHistoryDTO userRequestHistoryDTO);
